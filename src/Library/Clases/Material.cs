...
namespace Library
{
    ...
    public class Material : IConversorTexto
    {
        ...
        /// </summary>
        public List<string> PosiblesCategorias = new List<string>() { "/quimicos", "/plasticos", "/celulosicos", "/electricos", "/textiles", "/metalicos", "/metalicosferrosos", "/solventes", "/vidrio", "/residuosorganicos", "/otros" };
