...
namespace Ucu.Poo.Locations.Client
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether obtiene o establece un valor que indica si se encontró o no la dirección. En ese caso son válidos los demás
        ...
        /// <summary>
        /// Gets or sets obtiene o establece la dirección: calle y número, ruta y kilómetro, etc.
        /// </summary>
        /// <value>Por ejemplo, Avenida 8 de Octubre 2738.</value>
        public string AddresLine { get; set; }

        /// <summary>
        /// Gets or sets obtiene o establece el país.
        /// </summary>
        /// <value>Por ejemplo, Uruguay.</value>
        public string CountryRegion { get; set; }

        /// <summary>
        /// Gets or sets obtiene o establece la dirección completa, incluyendo ciudad, código postal, etc.
        /// </summary>
        /// <value>Por ejemplo, Avenida 8 de Octubre 2738, Montevideo, 11200, Uruguay.</value>
        public string FormattedAddress { get; set; }

        /// <summary>
        /// Gets or sets obtiene o establece la localidad o ciudad.
        /// </summary>
        /// <value>Por ejemplo, Montevideo.</value>
        public string Locality { get; set; }

        /// <summary>
        /// Gets or sets obtiene o establece el código postal.
        /// </summary>
        /// <value>Por ejemplo, 11200.</value>
        public string PostalCode { get; set; }

        /// <summary>
        /// Gets or sets obtiene o establece la latitud de la dirección.
        /// </summary>
        /// <value>El valor de la latitud en formato decimal.</value>
        public double Latitude { get; set; }

        /// <summary>
        /// Gets or sets obtiene o establece la longitud de la dirección.
        /// </summary>
